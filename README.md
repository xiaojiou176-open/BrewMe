...
| **Plugin-grade bundles and official-surface templates** | builders who want the strongest public bundles or distribution templates beyond docs-only starters | real today through `starter-packs/codex/brewme-codex-plugin/`, `starter-packs/claude-code/brewme-claude-plugin/`, `starter-packs/openclaw/clawhub.package.template.json`, and `starter-packs/mcp-registry/brewme-server.template.json`; readiness differs by platform |
