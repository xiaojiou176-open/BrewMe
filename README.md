...
| **Build on top of BrewMe** | [docs/builders.md](./docs/builders.md) and [docs/public-distribution.md](./docs/public-distribution.md) | these pages keep MCP, API, CLI, SDK, starter packs, and official submit/read-back truth out of the newcomer path |
