...
| **Plugin-grade bundles** | builders who want Codex / Claude Code / OpenClaw / MCP submission-ready artifacts instead of docs-only starters | real today through `starter-packs/codex/brewme-codex-plugin/`, `starter-packs/claude-code/brewme-claude-plugin/`, `starter-packs/openclaw/clawhub.package.template.json`, and `starter-packs/mcp-registry/brewme-server.template.json` |
