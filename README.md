...
| **Run BrewMe as an operator** | [docs/start-here.md](./docs/start-here.md), then `/subscriptions`, `/search`, and `/ops` after local boot | this is the shortest truthful path from clone to intake, evidence, and triage |
