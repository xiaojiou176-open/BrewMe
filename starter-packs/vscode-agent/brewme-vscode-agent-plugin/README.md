# BrewMe VS Code Agent Plugin Bundle

This bundle is the strongest repo-tracked VS Code agent plugin artifact
BrewMe can ship today without overclaiming a VS Code Marketplace listing.
...
- it is not proof that BrewMe is live-listed in the VS Code Marketplace
