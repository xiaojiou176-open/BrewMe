# BrewMe OpenClaw Pack

This is the first public OpenClaw local starter pack for BrewMe.
...
- `starter-packs/openclaw/brewme-mcp-template.json`
- `starter-packs/openclaw/openclaw.plugin.json`
- `starter-packs/openclaw/skills/brewme-watchlist-briefing/SKILL.md`
- `starter-packs/openclaw/skills/brewme-watchlist-briefing/references/mcp-and-http-setup.md`
- `starter-packs/openclaw/skills/brewme-watchlist-briefing/references/capability-map.md`
