...
These starter packs are the first public workflow surface for BrewMe.
...
| prepare a Codex-compatible plugin bundle | `starter-packs/codex/brewme-codex-plugin/` | plugin-grade local bundle today; official Codex listing still unavailable for self-serve publishing |
