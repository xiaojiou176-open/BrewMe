# BrewMe Codex Plugin Bundle

This bundle is the strongest public Codex distribution artifact BrewMe can
...
- a BrewMe MCP template with the repo-root placeholder already wired
...
- it is not proof that BrewMe is officially listed in the Codex Plugin Directory
