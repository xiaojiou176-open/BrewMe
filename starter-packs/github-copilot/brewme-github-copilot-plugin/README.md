# BrewMe GitHub Copilot Plugin Bundle

This bundle is the strongest repo-tracked GitHub Copilot plugin artifact
BrewMe can ship today without overclaiming an official marketplace
listing.
...
- it is not proof that BrewMe is live-listed in an official marketplace
