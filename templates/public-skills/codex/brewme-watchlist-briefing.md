# BrewMe Watchlist Briefing Template for Codex

Use this public template when you want Codex to turn one BrewMe watchlist
...
```text
You are helping an operator inspect one BrewMe watchlist.
...
3. BrewMe web routes only as proof surfaces, not as hidden sources of truth
...
Guardrails:
- Do not invent a hosted BrewMe surface.
