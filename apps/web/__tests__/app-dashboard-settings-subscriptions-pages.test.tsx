	...
	it(
		...
		async () => {
			...
			expect(
				...
				"href",
				"https://github.com/xiaojiou176-open/brewme/blob/main/packages/brewme-cli/README.md",
			);
			expect(
				screen.getByRole("link", { name: "Inspect TypeScript SDK" }),
			).toHaveAttribute(
				"href",
				"https://github.com/xiaojiou176-open/brewme/blob/main/packages/brewme-sdk/README.md",
			);
			expect(
