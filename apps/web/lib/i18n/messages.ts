...
const MESSAGES = {
	en: {
		...
		dashboard: {
			...
			metadataDescription:
				"BrewMe command center for AI knowledge intake, grounded retrieval, operator triage, and builder entry through MCP and HTTP API.",
			kicker: "BrewMe Command Center",
			...
			whyNow: {
				...
				returnLoopDescription:
					"Watchlists, trends, briefings, bundles, and the playground make BrewMe a reusable control tower instead of a one-shot summarizer.",
			},
			firstHop: {
				...
				operateTitle: "Run BrewMe as an operator",
				operateDescription:
		...
		mcpPage: {
			...
			relationshipDescription:
				"Web is the operator-facing command center. API is the shared contract. MCP is the agent-facing surface. BrewMe routes MCP through the API instead of letting tools talk straight to the database.",
			searchCta: "Open Search",
			askCta: "Open Ask",
		},
		knowledgePage: {
		...
		searchPage: {
			...
			searchKicker: "BrewMe Search Front Door",
			askKicker: "BrewMe Ask Front Door",
			searchTitle: "Search",
			askTitle: "Ask your sources",
			searchSubtitle:
		...
		watchlistsPage: {
			...
			alertDescription:
				"BrewMe can already persist watchlists and reuse them inside the dashboard. Whether external alerts are ready depends on the notification gate, not on whether the form submission succeeds.",
			alertFallback:
		...
		builderSurfaces: {
			...
			subtitle:
				"Use BrewMe as an agent-facing control tower through MCP, the HTTP API, the thin repo-local CLI facade, and the shared TypeScript client layer.",
			mcpCta: "Open MCP quickstart",
	...
	"zh-CN": {
		...
		dashboard: {
			metadataTitle: "首页",
			metadataDescription:
				"BrewMe command center，用一个 operator-facing control tower 管 AI knowledge intake、grounded retrieval、ops triage 与 builder entry。",
			kicker: "BrewMe Command Center",
			heroTitle: "AI 知识控制塔",
			heroSubtitle:
			...
			whyNow: {
				...
				returnLoopDescription:
					"Watchlists、trends、briefings、bundles 和 playground 让 BrewMe 更像会持续复用的控制塔，而不是一次性的摘要脚本。",
			},
			firstHop: {
				...
				operateTitle: "把 BrewMe 当成 operator 产品来跑",
				operateDescription:
		...
		mcpPage: {
			...
			relationshipDescription:
				"Web 是 operator-facing command center。API 是共享契约。MCP 是 agent-facing surface。BrewMe 会先经过 API，而不是让工具直接打数据库。",
			searchCta: "打开 Search",
			askCta: "打开 Ask",
		},
		knowledgePage: {
		...
		watchlistsPage: {
			...
			alertDescription:
				"BrewMe 现在已经能保存 watchlist 并在 dashboard 内复用。外发提醒是否 ready，要看 notification gate，而不是看表单有没有提交成功。",
			alertFallback:
		...
		builderSurfaces: {
			...
			subtitle:
				"把 BrewMe 当作 agent-facing control tower 使用：走 MCP、HTTP API、薄的 repo-local CLI 门面和共享 TypeScript client layer，而不是复制一套新的业务逻辑。",
			mcpCta: "打开 MCP quickstart",
