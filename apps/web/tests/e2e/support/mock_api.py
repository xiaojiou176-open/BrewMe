                ...
                payload = {
                    ...
                    "templates": [
                        ...
                        },
                        {
                            ...
                            "source_url_required": False,
                            "supports_video_pipeline": False,
                            "fill_now": "Bring the exact RSSHub route you want BrewMe to poll, then add a canonical source URL only if it helps operators recognize the feed.",
            ...
            if path == "/api/v1/notifications/test":
                ...
                self._send_json(
                    HTTPStatus.OK,
                    {
                        ...
                        "subject": payload.get("subject") or "BrewMe test notification",
                        "sent_at": now,
                        "created_at": now,
                    },
                )
