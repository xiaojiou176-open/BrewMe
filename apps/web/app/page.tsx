...
const FIRST_HOP_DOC_LINKS = {
	seeItFast:
		"https://github.com/xiaojiou176-open/brewme/blob/main/docs/see-it-fast.md",
	startHere:
		"https://github.com/xiaojiou176-open/brewme/blob/main/docs/start-here.md",
	publicDistribution:
		"https://github.com/xiaojiou176-open/brewme/blob/main/docs/public-distribution.md",
} as const;
...
export default async function DashboardPage({
	...
	return (
		<div className="folo-page-shell folo-unified-shell">
			...
			<section
				className="grid gap-4 xl:grid-cols-3"
				aria-label="Choose your first BrewMe path"
			>
				<h2 className="text-sm font-semibold uppercase tracking-[0.2em] text-muted-foreground xl:col-span-3">
			...
			<section aria-label="BrewMe builder entry points">
			...
			<section
				...
				aria-label="BrewMe compounder surfaces"
			>
