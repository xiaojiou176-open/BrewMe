...
const HomeScene: React.FC<BrewMeFrontDoorProps> = ({
	title,
	subtitle,
}) => {
...
const PublicFaceScene: React.FC = () => {
	...
	return (
		<SceneShell light>
			...
			>
				<ScreenshotCard
					src={staticFile("brewme-social-preview.png")}
					frame={frame}
				...
				<div style={{ display: "grid", gap: 18 }}>
					...
					>
						BrewMe should read like a product: see the story, inspect the
	...
	return (
		<SceneShell>
			...
			>
				...
				>
					<SectionLabel text="BrewMe" light />
					<div
						style={{
							fontSize: 76,
							lineHeight: 0.97,
...
export const BrewMeFrontDoor: React.FC<BrewMeFrontDoorProps> = ({
	title,
	subtitle,
}) => {
	const frame = useCurrentFrame();
