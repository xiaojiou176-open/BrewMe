...
def send_test_email(
    ...
    *,
    ...
    return _dispatch_email(
        ...
        subject=subject or "BrewMe test notification",
        text_body=body or "This is a test notification from BrewMe.",
...
def send_failure_alert(
    ...
    *,
    ...
    return _dispatch_email(
        ...
        kind="failure_alert",
        recipient_email=recipient,
        subject=f"[BrewMe] Failure alert: {title}",
        text_body=details,
...
def send_daily_digest(
    ...
    *,
    ...
    return _dispatch_email(
        ...
        kind="daily_digest",
        recipient_email=recipient,
        subject=subject or f"[BrewMe] Daily digest {effective_date.isoformat()}",
...
def send_video_digest(
    ...
    *,
    ...
    return _dispatch_email(
        ...
        kind="video_digest",
        recipient_email=recipient,
        subject=subject or "[BrewMe] Video digest",
        text_body=digest_markdown,
...
def send_category_digest(
    ...
    *,
    ...
    return _dispatch_email(
        ...
        kind="daily_digest",
        recipient_email=recipient,
        subject=subject or f"[BrewMe] {normalized_category} digest",
        text_body=digest_markdown,
...
def send_daily_report_notification(
    ...
    *,
    ...
    return send_daily_digest(
        db,
        digest_markdown=body or f"BrewMe daily report for {effective_date.isoformat()}",
