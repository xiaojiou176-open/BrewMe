...
- `starter-packs/mcp-registry/brewme-server.template.json`
- `pyproject.toml`
- `docs/mcp-quickstart.md`
- `docs/media-kit.md`
- `docs/assets/brewme-social-preview.png`
- `docs/assets/brewme-square-icon.png`
- `docs/assets/brewme-mcp-directory-shot-01.png`

## Suggested Field Mapping

| mcpservers.org field shape | BrewMe repo-owned source |
| --- | --- |
...
| install / command / transport | `config/public/mcp-directory-profile.json -> entrypoint`, `starter-packs/mcp-registry/brewme-server.template.json` |
...
| screenshot | `docs/assets/brewme-mcp-directory-shot-01.png` |
