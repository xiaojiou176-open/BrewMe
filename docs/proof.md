...
Historical plans under `.agents/Plans/` are archived execution context only. They can explain how the repo arrived here, but they must not be treated as the current public truth for BrewMe.
