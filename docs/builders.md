...
- **MCP**: the root Python package now produces the real `brewme-mcp` install artifact and the registry template points at the PyPI identifier `brewme`; live registry/PyPI read-back still needs submit/publish proof.
