...
用途：定义 `BrewMe` reader-product reset 的产品对象模型、处理流水线、默认参数与改造边界。
...
- `.agents/Plans/2026-04-08__brewme-reader-product-wave-program.md`
...
- `.agents/Plans/2026-04-09__brewme-W1-A-object-contract-closeout.md`
- `.agents/Plans/2026-04-09__brewme-W1-B-version-gap-closeout.md`
...
- `.agents/Plans/2026-04-09__brewme-W2-A-lane-split-closeout.md`
- `.agents/Plans/2026-04-09__brewme-W2-B-intake-front-door-closeout.md`
...
`BrewMe` 的下一阶段目标是：把多源长内容 intake 先落成高保真单信息源文档，再按主题无损合并/润色成面向读者的阅读成品，并通过 reader-first 首页、详情页与导航日报交付给用户。
