...
| `starter-packs/mcp-registry/brewme-server.template.json` | official MCP Registry metadata template | public, metadata-only template, not a live registry publish receipt |
...
Codex and Claude Code already fit BrewMe through MCP + HTTP API.
