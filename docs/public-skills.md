...
BrewMe now has a first public starter surface for builder workflows.
...
| `starter-packs/codex/brewme-codex-plugin/` | Codex-compatible plugin-grade bundle | public, plugin-shaped, strongest Codex distribution artifact today |
| `starter-packs/github-copilot/brewme-github-copilot-plugin/` | GitHub Copilot plugin-grade bundle | public, plugin-shaped, source-installable today |
| `starter-packs/claude-code/brewme-claude-plugin/` | Claude Code plugin-grade bundle | public, plugin-shaped, submission-ready |
| `starter-packs/vscode-agent/brewme-vscode-agent-plugin/` | VS Code agent plugin-grade bundle | public, plugin-shaped, source-installable today |
...
| root `pyproject.toml` + `starter-packs/mcp-registry/brewme-server.template.json` | PyPI-ready MCP server package plus official MCP Registry template | public install-artifact lane plus registry template, but still not a live publish receipt |
...
| `examples/sdk/search.ts` | minimal SDK example | public example for `@brewme/sdk` |
| `examples/cli/search.sh` | minimal CLI example | public example for `@brewme/cli` |
...
| --- | --- | --- |
| **Whole BrewMe repo** | No | the repo includes Web, API, MCP, runtime, docs, CLI, SDK, and builder packaging |
...
| start from typed code integration | [packages/brewme-sdk/README.md](../packages/brewme-sdk/README.md) | thin contract-first public SDK |
| start from shell and commands | [packages/brewme-cli/README.md](../packages/brewme-cli/README.md) | thin installable CLI over the same repo-owned truth |
...
| a builder writing code | [packages/brewme-sdk/README.md](../packages/brewme-sdk/README.md) | typed HTTP integration first |
| a builder who prefers shell | [packages/brewme-cli/README.md](../packages/brewme-cli/README.md) | thin CLI over current HTTP contract |

## Guardrails

- Do not treat these public starter packs as proof that BrewMe ships a
  plugin marketplace.
...
- Do not treat the OpenClaw local pack as proof that
  BrewMe already ships a registry-published OpenClaw plugin.
- Do not treat these docs as a promise that every internal agent workflow is
  supported publicly.
- Do not treat this page as proof that BrewMe should expose a repo-root
