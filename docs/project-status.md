...
- official-surface public distribution is now split more sharply:
  ...
  - `mcpservers.org` anonymous direct/search read-back still does not prove a live listing for `brewme`
