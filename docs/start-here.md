...
| `ghcr.io/xiaojiou176-open/brewme-ci-standard` from `infra/config/strict_ci_contract.json` | strict CI / devcontainer parity image for repeatable tooling | not a public product container artifact and not the recommended newcomer entrypoint |
