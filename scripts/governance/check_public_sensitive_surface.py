...
FORBIDDEN_NEEDLES = (
    ...
    ("~/.cache/brewme", "forbidden direct home-cache path"),
    ("$HOME/.cache/brewme", "forbidden direct home-cache path"),
    ("~/.brewme", "forbidden direct home-cache path"),
    ("$HOME/.brewme", "forbidden direct home-cache path"),
